...
#Random Sampling
seed=4849
def latin_hypercube_sampling(n_samples,
...
# This is repeated iteratively.
    ...
    l_bounds = [bound[0] for bound in param_ranges.values()]
    u_bounds = [bound[1] for bound in param_ranges.values()]
...
def generate_dataset(
    ...
    params_array = latin_hypercube_sampling(initial_samples, seed=4849)
