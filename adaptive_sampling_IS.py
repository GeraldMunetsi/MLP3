...
tmax=200 
n_timepoints=200
initial_samples =200       # initial Sobol samples
iterations = 10            # AIS iterations
sigma = 0.005               # width of R0 target distribution
...
def systematic_resample(samples, weights):
    """
    Systematic resampling — draw N new samples from the IS-weighted set.
    Instead of random independent draws, systematic sampling forces samples to be evenly spaced across the weight distribution
